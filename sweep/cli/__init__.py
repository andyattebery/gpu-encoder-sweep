...
VERBS = OrderedDict([
    ...
    ("add-host", verb("/catalogue/add-host", "host", "ssh_host", "os", "machine", "work_root", "ffmpeg", "local_view", "notes")),
    ...
    ("inventory", verb("/runs/inventory", "library", ("titles", jsonarg))),
    ...
    ("publish", verb("/runs/publish", "run_id", ("cut_ids", csv))),

...
PY ?= python3
TESTS = tests.test_model_check tests.test_recipes tests.test_hub_store tests.test_hub_app tests.test_hub_catalogue tests.test_cli tests.test_hub_sample tests.test_hub_search tests.test_hub_decision tests.test_hub_ingest tests.test_hub_queue tests.test_hub_artifact tests.test_hub_export tests.test_refusals tests.test_hub_replay
